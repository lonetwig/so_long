...
/*   Updated: 2024/01/28 18:14:31 by ealislam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((key == 13 || key == 126) && nearby->top.is_enemy)
		return (1);
	if ((key == 2 || key == 124) && nearby->right.is_enemy)
		return (1);
	if ((key == 1 || key == 125) && nearby->down.is_enemy)
		return (1);
	if ((key == 0 || key == 123) && nearby->left.is_enemy)
		return (1);
	return (0);
}
