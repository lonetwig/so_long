...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   initialize_info_bonus.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ealislam <ealislam@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/24 16:13:10 by ealislam          #+#    #+#             */
/*   Updated: 2024/01/29 10:40:01 by ealislam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	initialize_info(t_all *info, char *path)
{
	...
	x_size = (info->map_info.width + info->map_info.pad_x + 3) * 32;
	y_size = (info->map_info.height + info->map_info.pad_y + 5) * 32;
	get_player_pos(info);
	info->time = 0;
